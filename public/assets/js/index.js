...
if (window.location.pathname === '/notes') {
  ...
  saveNoteBtn = document.querySelector('.save-note'); // Ensure this targets the correct element
...
const handleNoteSave = () => {
  console.log('Title and text values:', noteTitle.value, noteText.value); // Add this line
  const newNote = {
